...
local window = library:AddWindow("BLX clan Script👍😔", { main_color = Color3.fromRGB(41, 74, 122), min_size = Vector2.new(600, 550), can_resize = false })

local Paid = window:AddTab("Op")
